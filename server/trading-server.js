...
function generateExitDetail(reason, pos, exitPrice, peakPremium) {
    ...
    const SL_PCT = { ema_crossover: 15, ema_confluence: 15, orion: 30, supertrend: 20, pcr_reversal: 25, gap_orb: 20, vwap_scalper: 20, ema_crossover_1m: 15 };
    const TRAIL_PCT = { ema_crossover: 10, ema_confluence: 10, orion: 15, supertrend: 12, pcr_reversal: 12, gap_orb: 12, vwap_scalper: 12, ema_crossover_1m: 10 };
    const CLOSE_TIME = { ema_crossover: "3:20 PM", orion: "3:20 PM", ema_confluence: "3:20 PM", supertrend: "3:20 PM", pcr_reversal: "3:20 PM", gap_orb: "3:20 PM", vwap_scalper: "3:20 PM", ema_crossover_1m: "3:20 PM" };
    switch (reason) {
        case "SL_HIT": {
