    ...
    <div className="flex-1 p-6 min-h-screen text-white fade-in">
      ...
      >
        {[
          ...
          >
            <p className="font-pixel text-[1.47rem] text-zinc-600 mb-2 tracking-widest">
              {item.label}
            </p>
            <p className="font-pixel text-[1.47rem]" style={{ color: item.color }}>
              {item.value}
            </p>
          </div>
        ))}
      ...
      >
        <div>
          ...
          <p
            className="font-pixel text-[1.47rem]"
        ...
        {btcChange24h !== 0 && (
          <p
            className="font-pixel text-[1.47rem] mt-1"
        ...
        <div className="ml-auto flex items-center gap-2">
          ...
          />
          <span className="font-pixel text-[1.47rem] text-green-400">
            MARKET OPEN 24/7
          </span>
        </div>
      </div>
              ...
              >
                ...
                <div className="flex items-center gap-8">
                  <div className="text-right">
                    <p className="font-pixel text-[1.47rem] text-zinc-700 mb-1 tracking-widest">
                      CAPITAL
                    </p>
                    <p className="font-pixel text-[1.47rem] text-white">
                      ₹{fmtINR(capital)}
                    </p>
                  </div>
                  <div className="text-right">
                  ...
                  <div className="text-right">
                    ...
                    <p className="font-pixel text-[1.47rem] text-zinc-500">
                      {botPos.length}
                      {openPos.length > 0 && (
