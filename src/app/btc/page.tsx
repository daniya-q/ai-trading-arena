    ...
    <div className="flex-1 p-6 min-h-screen text-white fade-in">
      ...
      >
        {[
          ...
          >
            <p className="font-pixel text-6xl text-zinc-600 mb-2 tracking-widest">
              {item.label}
            </p>
            <p className="font-pixel text-6xl" style={{ color: item.color }}>
              {item.value}
            </p>
          </div>
        ))}
      ...
      >
        ...
        {btcChange24h !== 0 && (
          <p
            className="font-pixel text-6xl mt-1"
        ...
        <div className="ml-auto flex items-center gap-2">
          ...
          />
          <span className="font-pixel text-6xl text-green-400">
            MARKET OPEN 24/7
          </span>
        </div>
      </div>
